        ...
        if(isComment == false){
            ...
            if(token_list[j].type == P_DEREF8)
            {
                if(!numeric_stack.empty()){
                    ...
                    cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: no location give can not dereference memory of `i8` stack" << endl;
                    break;
                }
            }
            ...
            if(token_list[j].type == P_PUSH8)
            {
                if(numeric_stack.size() > 1){
                    ...
                    cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: can not write data in `i8` stack incomplete `!i8` instruction" << endl;
                    break;
                }
            }
            ...
            if(token_list[j].type == P_FUNC_PUTS)
            {
                if(numeric_stack.size() > 1){
                    ...
                    cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: to few arguments to function `[int: begin int: end] puts`" << endl;
                    break;
                }
            }
            ...
            if(token_list[j].type == P_FUNC_PUTC){
                if(numeric_stack.size() > 0){
                    cout << memory[numeric_stack.top()];
                    numeric_stack.pop();
                }else{
                    cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: to few arguments to function `[int: loc] putc`" << endl;
                    break;
                }
            }
            ...
            if(token_list[j].type == P_THEN){
                ...
                if(jmp == -1){
                    if(ptoken.top() == P_IF){
                        ...
                        cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: expected an `end` if THIS `while` statement"<< endl;
                    }
                    break;
                } 
            ...
            if(token_list[j].type == P_WHILE)
            {
                ...
                if(location == -1){
                    cout << filename << ":" << token_list[j].r << ":" << token_list[j].c << ": ERROR: incomplete `while` statement definition" << endl;   
                    break;
                } 
