...
char *tt_sign[] = {"int","str","cstr","char","+","-","*","/","=","!=",">","<",">=","<=","not","band","bor","beor","shl","shr","print","write","puts","dup","mod","swap","drop","over","rot","nip","dupd","swapd","memory","memread","*memory","if","then","end","else","while",";;","unexpected"};
